...
This vignette introduces `flocker` with examples focused on "standard" single-season models (including multispecies models). For help with other model types, following the links here for [the data-augmented model](), [dynamic (multiseason) models](), and [false-positive models](). In the remainder of this vignette, we
