...
**closure-unit**: The groupings of observations over which [closure](https://jsocolar.github.io/closureOccupancy/) is assumed. In single-species models, a closure-unit corresponds to a "site" or "point". In multi-species models, a closure-unit is a species-site combination. In dynamic (multiseason) models, a closure-unit is a site-season combination (or species-site-season in a multispecies dynamic model).
