...
test_that("make_occupancy_single_fp_lpdf works correctly", {
  # Test with max_rep = 2
  stan_code_2 <- make_occupancy_single_fp_lpdf(2)
  expect_match(stan_code_2, "array[] int vint4", fixed = TRUE)
  expect_match(stan_code_2, "array[] int vint5", fixed = TRUE)
  expect_no_match(stan_code_2, "array[] int vint6", fixed = TRUE)
  ...
  # Test with max_rep = 1 (invalid input)
  expect_error(make_occupancy_single_fp_lpdf(1), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = -2 (invalid input)
  expect_error(make_occupancy_single_fp_lpdf(-2), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = 3.5 (invalid input)
  expect_error(make_occupancy_single_fp_lpdf(3.5), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = "foo" (invalid input)
  expect_error(make_occupancy_single_fp_lpdf("foo"), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = c(2, 3) (invalid input)
  expect_error(make_occupancy_single_fp_lpdf(c(2, 3)), "max_rep must be an integer greater than 1")
})

test_that("make_occupancy_multi_colex_fp_lpdf works correctly", {
  # Test with max_rep = 2, max_year = 3
  stan_code_23 <- make_occupancy_multi_colex_fp_lpdf(2, 3)
  expect_match(stan_code_23, "array[] int vint6", fixed = TRUE)
  expect_match(stan_code_23, "array[] int vint7", fixed = TRUE)
  expect_match(stan_code_23, "array[] int vint8", fixed = TRUE)
  expect_match(stan_code_23, "array[] int vint9", fixed = TRUE)
  ...
  # Test with max_rep = 1 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(1, 2), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = "foo" (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf("foo", 2), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = c(2, 3) (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(c(2, 3), 2), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = -2 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(-2, 2), "max_rep must be an integer greater than 1")
  
  # Test with max_rep = 3.5 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(3.5, 2), "max_rep must be an integer greater than 1")
  
  # Test with max_year = 1 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(2, 1), "max_year must be an integer greater than 1")
  
  # Test with max_rep = -2 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(2, -2), "max_year must be an integer greater than 1")
  
  # Test with max_rep = 3.5 (invalid input)
  expect_error(make_occupancy_multi_colex_fp_lpdf(2, 3.5), "max_year must be an integer greater than 1")
})
