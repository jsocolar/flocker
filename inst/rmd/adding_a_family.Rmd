...
the lens of everthing that needs to happen in order to add a new family.
...
`flocker_data_output_types()` in utils.R. If appropriate, add to 
`rep_constant_types()`, `threading_types()`, or `multi_types()`.
...
provide an example dataset in the data folder and document it properly in 
data.R.
